...
compute_sound(){
   ...
   -num_phases_mics 8 -saved_data_dir_path default \
      ...
      -chunk "$chunk" -total_gpus_available "$total_number_of_chunks" -fix_corrupted \
      -compress_data \
      -use_small_dense_room
...
while [ $(ls -A "/mnt/walkure_public/tamirs/pressure_field_orientation_dataset/small_dense_room/default_5.0_5.0_order_1_0.5_d_0.05/rir/rir_indoor/" | wc -l) -ne 0 ]; do
