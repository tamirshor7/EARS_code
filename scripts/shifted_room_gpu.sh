...
compute_sound(){
    ...
    python EARS/forward_model/forward_indoor_wrapper.py -max_order 1 \
      ...
      -num_phases_mics 8 -saved_data_dir_path default \
         ...
         -gpu $which_gpu \
         -compute_sound_only -number_of_angles 64 \
         -chunk $chunk -total_gpus_available $total_number_of_chunks \
         -compress_data --folder_name "shifted_room" -margins 0.03
...
while [ $(ls -A "/mnt/walkure_public/tamirs/pressure_field_orientation_dataset/shifted_room/default_5.0_5.0_order_1_0.5_d_0.05/rir/rir_indoor/" | wc -l) -ne 0 ]; do
