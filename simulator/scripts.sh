python EARS/simulator/elaborate.py --mode "free_space" \
 --path "entire_room_org_2.5_2.5_rotors_1_free_space" 

python EARS/simulator/elaborate.py --mode "free_space" \
 --path "entire_room_org_2.5_2.5_rotors_4_free_space_and_indoor" 

python EARS/simulator/elaborate.py --mode "indoor" \
 --path "entire_room_org_2.5_2.5_rotors_4_free_space_and_indoor" 

python EARS/simulator/elaborate_modulate_phase.py --mode "indoor" \
...
python EARS/simulator/elaborate_modulate_phase.py --mode "free_space" \
